@testset "Periodic Panel Tests" begin
    ...
    @test panels.npanels == 4
    @test isapprox(panels.panel_angle, [-2.03444, -4.24874, 1.10715, -1.10715], atol = 0.001)
    @test isapprox(panels.delta_angle, [-1.01722, 1.570795, 1.570795, -0.553575], atol = 0.001)
end
