...
**Arguments:**
- `leradius::Float` : Leading Edge Radius
- `tecamberangle::Float` : Trailing Edge Camber Angle (degrees)
- `wedgeangle::Float` : Wedge Angle (degrees)
...
### Inputs:
    ...
    - xpos : x position of the 2nd and 6th control points in degree 3.
    - leradius : Leading edge radius
    - wedgeangle : The trailing edge wedge angle
    - tedz : The trailing edge gap
...
"""
function definespline(degree, xpos, leradius, tecamberangle, wedgeangle, tedz, weights)
    #Convert to radians
    boattailangle = pi * wedgeangle / 360 #boattail angle is half of wedge angle
    tecamberangle *= pi / 180
