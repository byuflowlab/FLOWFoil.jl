...
inviscid_problem = FLOWFoil.Problem([m3; m2 ], 4.0, 0.0; viscous=false)
...
# contour(x, z, stream, 25; linewidths=2, linestyles="-", colors=[(0.251, 0.388, 0.847)])

xu, xl, yu, yl = naca4(12.0, 5.0, 44.0; split=true)
fill_between(xu, yu, reverse(yl); color=(0.22, 0.596, 0.149), zorder=2)
plot(xu, yu; color=(0.22, 0.596, 0.149), zorder=3)
plot(xl, yl; color=(0.22, 0.596, 0.149), zorder=3)
...
plot(xu, yu; color=(0.584, 0.345, 0.698), zorder=3)
plot(xl, yl; color=(0.584, 0.345, 0.698), zorder=3)
...
plot(xu, yu; color=(0.796, 0.235, 0.2), zorder=3)
plot(xl, yl; color=(0.796, 0.235, 0.2), zorder=3)
